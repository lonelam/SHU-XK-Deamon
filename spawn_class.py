...
def request_constructor(username, request_type, parameter):
    query_url = 'http://xk.autoisp.shu.edu.cn:8080/StudentQuery/CtrlViewQueryCourse'
    select_url = 'http://xk.autoisp.shu.edu.cn:8080/CourseSelectionStudent/CtrlViewOperationResult'
